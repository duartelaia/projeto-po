...
public class AddObserverVisitor implements Visitor{
    
    private Cell _currentCell;

    public AddObserverVisitor(Cell currentCell){
    ...
    /**
     * Default behaviour of an inteval function
     *
     * @param binFunction the inteval function
     */
    ...
    public void visit(Ref ref){
        ref.getCell().addObserver(_currentCell);
    }
